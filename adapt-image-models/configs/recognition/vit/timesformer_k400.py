...
# model settings
model = dict(
    backbone=dict(type='TimeSformer', drop_path_rate=0.1, adapter_scale=0.5, num_frames=8),
...
ann_file_train = 'data/kinetics400/train_video_list_10.txt'
...
# optimizer
optimizer = dict(type='AdamW', lr=3e-4, betas=(0.9, 0.999), weight_decay=0.000005,
