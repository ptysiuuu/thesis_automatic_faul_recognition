...
# model settings
model = dict(
    backbone=dict(patch_size=14,width=1024,layers=24,heads=16,drop_path_rate=0.2, adapter_scale=1, num_frames=8),
    cls_head=dict(in_channels=1024,num_classes=174),
