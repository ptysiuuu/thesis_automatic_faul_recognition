...
model = dict(
    ...
    cls_head=dict(in_channels=1024, num_classes=700),
    test_cfg=dict(max_testing_views=4))

# dataset settings
dataset_type = 'VideoDataset'
data_root = 'data/kinetics700/train_256'
data_root_val = 'data/kinetics700/val_256'
ann_file_train = 'data/kinetics700/train_video_list.txt'
ann_file_val = 'data/kinetics700/val_video_list.txt'
ann_file_test = 'data/kinetics700/val_video_list.txt'
img_norm_cfg = dict(
