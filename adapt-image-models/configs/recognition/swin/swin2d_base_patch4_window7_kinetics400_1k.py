_base_ = [
    '../../_base_/models/swin/swin2d_base.py', '../../_base_/default_runtime.py'
]
# model settings
model = dict(backbone=dict(frozen_stages=-1, drop_path_rate=0.3), test_cfg=dict(max_testing_views=4))
...
work_dir = './work_dirs/k400_swin2d_base_patch244_window877.py'
